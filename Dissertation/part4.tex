...
- при учете только ШИМ УМ (\textit{f\textsubscript{у }}= 8000Гц) и насыщения УМ погрешность наведения существенно не изменилась ( $\varDelta\alpha < 1.2^0$ ) (рисунок \ref{fig:az_digital4});\par
