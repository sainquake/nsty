...
\textbf{Азимут}
-при совместном учете насыщения УМ, дискретности ДУ и ШИМ УМ, погрешность наведения на угол 180\textsuperscript{0}\  равна\   = 0,2\textsuperscript{0} (рисунок \ref{fig:az_digital}).\par

\begin{figure}
	\centering
	\includegraphics[width=1.0\linewidth]{az_digital1} 
	\caption{КИМ 3, Процессы наведения ОЭП с учетом насыщения УМ, дискретности ДУ и ШИМ УМ (Кд1Ку1 Кк1=700 В/рад)}
	\label{fig:az_digital}
\end{figure}

-При этом изменение напряжения на выходе УМ в процессе наведения приведены на рисунке ниже (Рисунок \ref{fig:az_digita2}). Период переключений напряжений: (0,12 $  \div $  1,25) мс.\par
...
- уменьшение времени в ПУ до 0.5 секунд
...
-При этом изменение напряжения на выходе УМ в процессе наведения приведены на рисунке ниже (Рисунок \ref{fig:um_digita2}). Период переключений напряжений: (0,12 $  \div $  1,25) мс.\par
