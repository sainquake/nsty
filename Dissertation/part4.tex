...
Из анализа полученных процессов управления ОЭП по азимуту следует:\par

1)\ \ при развороте носителя с постоянной угловой скоростью  \textsubscript{вх1}(t) 425 по азимуту процессы управления ОЭП приведены на рис.31, где погрешность стабилизации не превышает  =0,18 град,\textit{ }\par

2)\  при гармонических колебаниях носителя по азимуту \par


\begin{equation}\tag{429}
\psi _{1} \left( t \right) =0,035sin \left( 6,28t \right) ,  \psi _{2} \left( t \right) =0,21sin \left( t \right) 
\end{equation}
погрешность стабилизации равна \ \ \   =0,17 град.\  (Рисунок 4.31), \par
...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=6.5in,height=6.35in]{./media/image78.png}
		\caption{сунок 4.30. Рис.31 Процессы стабилизации ОЭП при действии вх1 (t) (вариант 6):}
		\label{fig:_430_31______1_t__6}
	\end{Center}
\end{figure}
...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=6.5in,height=7.31in]{./media/image79.png}
		\caption{сунок 4.31. Рис.32 Процессы стабилизации ОЭП при действии вх1 (t) (варианты:1+2):}
		\label{fig:_431_32______1_t_12}
	\end{Center}
\end{figure}
...
3)\  при колебаниях носителя с амплитудой 20 град. и частотой 0,5 Гц  совместно с колебаниями 429 погрешность стабилизации равна  =0,4 град. (Рисунок 4.32), \par
...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=6.5in,height=6.47in]{./media/image80.png}
		\caption{сунок 4.32.Рис.33 Процессы стабилизации ОЭП при действии вх2 (t) (вариант 3):}
		\label{fig:_43233______2_t__3}
	\end{Center}
\end{figure}
...
- погрешность стабилизации,  - угловая скорость привода. \par

4)\ \ при\ остальных\ \ колебаниях носителя с амплитудами 20 град. с частотами 1 и  2  Гц (варианты 4 и 5) совместно с колебаниями  429 система управления не справляется с этими возмущениями из-за больших инерционных моментов ( \( J_{1} \psi _{4} \left( t \right)  \)  и  \( J_{1} \psi _{5} \left( t \right)  \) ). При снижении\  момента инерции первого тела в два раза погрешность стабилизации на\ частоте\  1 Гц будет составлять   =1,3 град, при снижении\ \ момента\ инерции первого тела на   30 $\%$  погрешность стабилизации на\ частоте\ \ 1Гц\ \ будет равна     =3  град.\par
...
1) при развороте носителя с постоянной угловой скоростью \textsubscript{вх1}(t) 430 процессы управления приведены на рис.36, где погрешность стабилизации ОЭП не превышает  =0,2 град\textit{. }\par
...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=6.5in,height=5.44in]{./media/image84.png}
		\caption{сунок 4.35. Рис.36. Процессы стабилизации ОЭП при действии вх1(t) (вариант 6) :}
		\label{fig:_435_36______1t__6_}
	\end{Center}
\end{figure}
...
\vspace{\baselineskip}
\begin{FlushRight}
	2)\  при гармонических колебаниях носителя по углу места \textsubscript{1}(t) и \textsubscript{2}(t) 
\end{FlushRight}\par


\begin{equation}\tag{433}
\vartheta _{1} \left( t \right) =0,035sin \left( 6,28t \right) ,  \vartheta _{2} \left( t \right) =0,21sin \left( t \right) 
\end{equation}
погрешность стабилизации равна \ \ \   =0,15 град. (Рисунок 4.36), \par
...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=6.44in,height=6.71in]{./media/image85.png}
		\caption{сунок 4.36. Рис.37. Процессы стабилизации ОЭП при действии вх1(t) (варианты:1+2):}
		\label{fig:_436_37______1t_12}
	\end{Center}
\end{figure}
...
3)\  при колебаниях носителя с амплитудой 20 град. и частотой 1 Гц  совместно с колебаниями 433 погрешность стабилизации равна  =0,4 град. (Рисунок 4.37),\par
...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=6.5in,height=7.68in]{./media/image86.png}
		\caption{сунок 4.37. Рис.38. Процессы стабилизации ОЭП при действии вх2(t) (вариант3,4):}
		\label{fig:_437_38______2t_34}
	\end{Center}
\end{figure}
...
\vspace{\baselineskip}4)\ \ при\  колебаниях носителя с амплитудой 20 град. и частотой 2  Гц (вариант 5) совместно с колебаниями 423\ погрешность стабилизации превышает допустимую величину в три раза –   =1,5 град (Рисунок 4.39), для обеспечения требований ТЗ добротность по скорости регулятора необходимо увеличить в 3 раза ( К\textsubscript{с2}=9000 с\textsuperscript{-1}, К\textsubscript{д2 }К\textsubscript{к2} К\textsubscript{у2}=\textit{ }1080 \textit{В/рад}) (Рисунок 4.40).\par
...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=6.5in,height=6.91in]{./media/image87.png}
		\caption{сунок 4.38. Рис.39. Процессы стабилизации ОЭП при действии вх2(t) (вариант5):}
		\label{fig:_438_39______2t_5}
	\end{Center}
\end{figure}
...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=6.5in,height=8.74in]{./media/image88.png}
		\caption{сунок 4.39. Рис.40. Процессы стабилизации ОЭП при действии вх2(t) (вариант5):}
		\label{fig:_439_40______2t_5}
	\end{Center}
\end{figure}
