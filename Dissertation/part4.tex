...
T_{m1} = 1.08 c, T_{e1} = 0.1 mc, T_{k1} = 0.05 c, T_{k1} = 0.5 mc,\\
...
Уравнения движения системы с учетом 46,47,414 и принятых ранее нелинейностей представим в виде :\par


\begin{equation}\tag{426}
\left( \begin{array}{ll}
\alpha =W_{n1} \left( p \right) U_{1}-W_{f1} \left( p \right) M_{H1}-W_{ \psi } \left( p \right)  \psi ,\\
U_{1}=F_{1} \left( U_{1} \right) ,U_{1}=f_{1} \left( U_{1} \right) ,U_{1}=К_{у1}⋅W_{k1} \left( p \right) U_{д1},\\
U_{д1}=K_{д1}⋅ \Delta  \alpha ,   \Delta  \alpha = \alpha _{вх}- \alpha , \alpha = \mu _{1} \left(  \alpha  \right) .\\
\end{array} \right} 
\end{equation}
где  \( F_{1} \left( U_{1} \right) -нелинейность насыщение УМ  \left(  \pm 27В \right) , \)  \[ f_{1} \left( U_{1} \right) -нелинейность ШИМ УМ \left( f_{y}=16кГц \right) , \]  \[  \mu _{1} \left(  \alpha  \right) -нелинейность дискретности цифрового  \]  \[ ДУ 14​​ разряда \left(  \Delta _{ду}=1,3183^{'} \right) . \] \par

Из линеаризованных уравнений (26) получим ПФ по ошибке \par


\begin{equation}\tag{427}
\Delta  \alpha =\frac{1}{1+W_{1} \left( p \right) } \alpha _{вх}-\frac{W_{f1} \left( p \right) }{1+W_{1} \left( p \right) }M_{тр1}-\frac{W_{ \psi } \left( p \right) }{1+W_{1} \left( p \right) } \left(  \psi _{1}+ \psi _{2} \right) 
\end{equation}

где


из которой следует (как и в линейной системе), что погрешность стабилизации зависит от трех составляющих: угловой скорости входного сигнала, момента нагрузки и ускорений колебаний носителя.\par

В установившемся режиме (t0, p0) имеем\par


\begin{equation}\tag{428}
\Delta  \alpha =\frac{1}{K_{C1}} \alpha _{вх}-\frac{K_{M1}}{K_{C1}}M_{тр1}-\frac{T_{M}}{K_{C1}} \left(  \psi _{1}+ \psi _{2} \right) ,    
\end{equation}
При заданных исходных данных, соответствующих регулятору САУ в режиме наведения по азимуту,\ разработана КИМ 5  (Рисунок 4.29), включающая в себя новую модель входных воздействий 425, измененные параметры нелинейностей (\textsubscript{ду}= 1,3183 угл. мин,\textit{ f\textsubscript{д }}= 16000Гц) , линейная и нелинейная части САУ в соответствии с системой уравнений 426.\par

Разработанная КИМ САУ для режима стабилизации (Рисунок 4.29) позволяет проводить исследования динамики процесса управления ОЭП, варьируя параметрами регулятора, объекта управления и возмущающими воздействиями в широких пределах в соответствии с исходными данными 425 и таблицей выше (Таблица 4.3).\par

На рисунках далее (Рисунок 4.30- Рисунок 4.32) приведены переходные и установившиеся процессы стабилизации ОЭП относительно заданного направления при действии указанных выше возмущений и нелинейностей 425. При этом коэффициенты датчика и усилителя должны быть не менее К\textsubscript{д2 }К\textsubscript{к2} К\textsubscript{у2}\textit{= }1000 В/рад. \par
