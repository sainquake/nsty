...
На основе синтезированных регуляторов САУ и с учетом указанных нелинейностей разработаны КИМ ЦСАУ (Рисунок 4.10). Модели с учетом нелинейностей КИМ позволяют изменять величины дискретности датчика, частоту ШИМ усилителя и насыщения в УМ и проводить исследования динамики нелинейной САУ при заданных пределах этих параметров. 


КИМ 2 нелинейной ЦСАУ по азимуту в режиме наведения


На Рис.11 –15 приведены результаты моделирования динамики наведения ОЭП с учетом указанных нелинейностей в канале азимута на угол  2\textsubscript{1}= 180\textsuperscript{0}, а на рис 24-27 в канале угла места на угол  2\textsubscript{1}= 90\textsuperscript{0}. Из анализа процессов наведения следует, что:\par





-при совместном учете насыщения УМ, дискретности ДУ и ШИМ УМ, погрешность наведения на угол 180\textsuperscript{0}\  равна\   = 0,2\textsuperscript{0} (Рисунок 4.11).\par


сунок 4.11. Рис.11. Процессы наведения ОЭП с учетом насыщения УМ, дискретности ДУ и ШИМ УМ (Кд1Ку1 Кк1=700 В/рад)


-При этом изменение напряжения на выходе УМ в процессе наведения приведены на рисунке ниже (Рисунок 4.12). Период переключений напряжений: (0,12 $  \div $  1,25) мс.\par




сунок 4.12. Рис.12. Изменение напряжения на выходе усилителя мощности в процессе наведения
