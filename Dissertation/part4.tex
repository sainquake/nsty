...
-При этом изменение напряжения на выходе УМ в процессе наведения приведены на рисунке ниже (Рисунок \ref{fig:az_digital2}). Период переключений напряжений: (0,12 $  \div $  1,25) мс.\par
