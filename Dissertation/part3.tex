...
\(  \left( B_{1}+B \left(  \beta  \right)  \right)  \alpha -D \left(  \beta  \right)  \beta -2F \left(  \beta  \right)  \alpha  \beta -E \left(  \beta  \right)  \beta ^{2}++ \left\{ - \omega _{x_{y}} \left( t \right)  \left[  \left(  \left( C_{2}-2A_{2} \left(  \beta  \right)  \right) cos \left(  \alpha  \right) +2E \left(  \beta  \right) sin \left(  \alpha  \right)  \right)  \right]  -- \left(  \omega _{y_{y}} \left( t \right) 2F \left(  \beta  \right) - \omega _{z_{y}} \left( t \right)  \left[  \left( 2E \left(  \beta  \right) cos \left(  \alpha  \right) - \left( C_{2}-2A_{2} \left(  \beta  \right)  \right) sin \left(  \alpha  \right)  \right)  \right]  \right}  \beta ++ \left\{ - \omega _{x_{y}} \left( t \right) F \left(  \alpha , \beta  \right)  + \left(  \omega _{y_{y}} \left( t \right)  \left( B_{1}+B \left(  \beta  \right)  \right) - \omega _{z_{y}} \left( t \right) D \left(  \alpha , \beta  \right)  \right} ++ \left\{ E \left(  \alpha , \beta  \right)  \omega _{x_{y}}^{2} \left( t \right) -E \left(  \alpha , \beta  \right)  \omega _{z_{y}}^{2} \left( t \right) + + \left( D \left(  \alpha , \beta  \right)  \omega _{x_{y}} \left( t \right)  \omega _{y_{y}} \left( t \right) +2A_{1} \left(  \alpha , \beta  \right)  \omega _{x_{y}} \left( t \right)  \omega _{z_{y}} \left( t \right) -F \left(  \alpha , \beta  \right)  \omega _{y_{y}} \left( t \right)  \omega _{z_{y}} \left( t \right)  \right} ==- \left( a_{O}^{T} \left( t \right) +g^{T}A_{c}^{T}A_{y}^{T} \right)  \left\{ m_{1} \left( \begin{matrix}
-x_{C_{1}}sin \left(  \alpha  \right) +z_{C_{1}}cos \left(  \alpha  \right) \\
0\\
-x_{C_{1}}cos \left(  \alpha  \right) -z_{C_{1}}sin \left(  \alpha  \right) \\
\end{matrix}
