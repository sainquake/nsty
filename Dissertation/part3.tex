...
-2 \alpha \beta F \left( \dot \alpha, \dot \beta \right) - {\dot \beta}^{2}E \left( \beta \right) \\
...
\end{multlined}
\end{equation}
Здесь и далее будем придерживаться обозначений, принятом в работе . 
...
F \left( \beta \right) =F_{2}cos \left( 2 \beta \right) -\frac{A_{2}-B_{2}}{2}sin \left( 2 \beta \right),\\
E \left( \beta \right) =E_{2}cos \left( \beta \right) -D_{2}sin \left( \beta \right),\\
D \left( \beta \right) =D_{2}cos \left( \beta \right) +E_{2}sin \left( \beta \right) .A_{2} \left( \beta \right) =\frac{A_{2}-B_{2}}{2}cos \left( 2 \beta \right) +F_{2}sin \left( 2 \beta \right),
\end{multlined}
\end{equation}
